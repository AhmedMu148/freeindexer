  ...
  <table width="600" cellpadding="0" cellspacing="0"
    ...
    <tr>
      <td style="padding:28px 24px">
        <h2 style="margin:0 0 12px;color:#222;font-size:20px">Support ticket opened</h2>
        <p style="margin:0 0 18px;color:#555;font-size:14px;line-height:1.7">Thanks {{ $username }}, your ticket
          <strong>#{{ $ticketId }}</strong> has been created.<br>Subject: <strong>{{ $subject }}</strong>
        </p>
    ...
    <tr>
      <td style="padding:18px 24px;background:#f8f9fa;color:#999;font-size:12px;text-align:center">Our team will
        get back to you shortly.</td>
    </tr>
  </table>
@endsection