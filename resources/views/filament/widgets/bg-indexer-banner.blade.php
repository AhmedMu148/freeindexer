  ...
  <x-filament::section>
    <div class="fi-simple-points">
      <div class="fi-simple-points__top">
        <span class="fi-simple-points__label">Your Remaining Points For Background Indexer</span>
  ...
  <x-filament::section>
    <div class="w-full mb-4 px-0">
      <div class="w-full bg-blue-600 text-white text-center py-4 rounded shadow">
        <div>
          <strong>Your Remaining Points For Background Indexer = </strong> {{ $available }}
        </div>
        <div>
          <strong>To Access More Points </strong>
          <a href="{{ route('pricing') }}" target="_blank" class="underline"><u>Upgrade Plan</u></a>
        </div>
      </div>
    </div>
  </x-filament::section>
